...
bool TextureShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, L"../Lux-Engine/texture.vs", L"../Lux-Engine/texture.ps");
	if (!result)
	{
		return false;
	}
...
void TextureShaderClass::OutputShaderErrorMessage(ID3D10Blob* errorMessage, HWND hwnd, WCHAR* shaderFilename)
{
	...
	MessageBox(hwnd, L"Error compiling shader. Check logs.", shaderFilename, MB_OK);
